...
(list)
_arguments "${_arguments_options[@]}" : \
'*--fields=[Fields to display. Available options are id, name, user, folder, type. Multiple fields will be separated by tabs.]:FIELDS:_default' \
...
'-l[List fields in this entry]' \
'--list-fields[List fields in this entry]' \
'-h[Print help]' \
'--help[Print help]' \
...
'-h[Print help]' \
'--help[Print help]' \
':shell:(bash zsh fish powershell elvish nushell fig)' \
&& ret=0
;;
(help)
_arguments "${_arguments_options[@]}" : \
